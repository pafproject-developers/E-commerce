...
import com.letstartcoding.springbootexample.service.deliveryService;

@Controller

public class delieryController {
	
	 @Autowired
	private deliveryService studentService;
	
	@RequestMapping(value ="/enroll",method = RequestMethod.GET)
	public String newRegistration(ModelMap model) {
		delivery student = new delivery();
		model.addAttribute("student", student);
		return "enroll";
	}
	
	@RequestMapping(value ="/save",method = RequestMethod.POST)
	public String saveRegistration(@Valid delivery student,
    ...
    public ModelAndView viewstudents(){  
        List<delivery> list=studentService.getAllStudents();
    ...
    public ModelAndView edit(@PathVariable int pageid){  
        ...
        List<delivery> list=studentService.getStudentsByPage(pageid,total);  
	...
	/* It opens the record for the given id in editstudent page */
	 @RequestMapping(value="/editstudent/{id}")  
	    public String edit(@PathVariable int id,ModelMap model){  
	       delivery student=studentService.getStudentById(id);  
	       model.addAttribute("student", student);
			return "editstudent";
	 ...
	 @RequestMapping(value="/editsave",method = RequestMethod.POST)  
	    public ModelAndView editsave(@ModelAttribute("student") delivery emp){  
